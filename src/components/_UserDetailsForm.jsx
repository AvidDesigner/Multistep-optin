...
export default function UserDetailsForm({ user, changeUserData, prevStep, nextStep, errors, validateForm }) {
    ...
    return (
        <Fragment>
            ...
            {(errors.email && errors.phone && !errors.name) && 
                    <label className="validation-error">*<span className="validation-text">{t('EmailError')}</span></label>
                    }
            {(errors.phone && !errors.name && !errors.email) && 
                    <label className="validation-error">*<span className="validation-text">{t('PhoneError')}</span></label>
                    }
